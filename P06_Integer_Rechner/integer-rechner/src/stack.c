...
stack_t *stack_new(size_t max_elements)
{
    ...
    instance->stack = malloc(max_elements * sizeof(stack_value_t)); 
    ...
    // 5. set the top member of the stack_t instance to the 
    //    address of the "element" before the first stack array element
...
int stack_is_empty(stack_t *instance)
{
    ...
    return instance->top == instance->stack - 1;
}
...
int stack_is_full(stack_t *instance)
{
    ...
    return instance->top == instance->full;
}
